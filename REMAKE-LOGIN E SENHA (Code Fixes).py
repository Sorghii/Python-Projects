...
while True:
    system('cls')
    print('To access the message, you must log into your account.')
        ...
        if passwordreg != confirm:
            ...
            while login == False:
                ...
                if login != 'Repeat': 
                    ...
                    login = False  # When the user have changed his password sucessfully.
            break
    ...
    if login == True:
        ...
        sleep(5)
        system('cls')
        print('This is my first code that isnt just a simple "1, 2, 3, 4". So, thank you for testing this. Please report to me any problems found in the code, bye bye!')      
        break
